...
const Index = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-4">
  <h2 className="text-xl font-semibold mb-2" style={{ width: '42%' }}>
  ...
  <h2 className="text-gray-600">How to Use this Tool</h2>
  <p>
  ...
  <h2 className="text-gray-600">Legal Considerations</h2>
  <p>
  ...
  <h2 className="text-gray-600">Compatibility</h2>
  <p>
  ...
  <h2 className="text-gray-600">SEO Considerations</h2>
  <p>
